...
const Privacy = () => (
    <PrivacyWrapper>
        ...
        <p>This Privacy Policy was last updated on January 20th, 2018.</p>

        <h3>
            Our Policy:
        </h3>
        <p>
            Welcome to the web site (the “Site”) of Beenest, Inc. (“Company”, “we”, “us” and/or “our”). 
            This Site is operated by us and has been created to, among other things, among other things, facilitate the sale of tokens 
            (the Site and any other products or services offered by us, collectively, the “Services”) to our Service visitors (“you”, “your”). 
            This Privacy Poliscy sets forth the Company’s policy with respect to information including personally identifiable data 
            (“Personal Data”) and other information that is collected from visitors to the Site and Services.
        </p>

        <h3>Information We Collect:</h3>
        When you interact with us through the Services, we may collect Personal Data and other information from you, as further described below:
            Personal Data That You Provide Through the Services: We may collect Personal Data from you when you voluntarily provide such information, such as when you contact us with inquiries, sign up for our listserv or use certain Services. Wherever the Company collects Personal Data we make an effort to provide a link to this Privacy Policy.
        By voluntarily providing us with Personal Data, you are consenting to our use of it in accordance with this Privacy Policy. If you provide Personal Data to the Services, you acknowledge and agree that such Personal Data may be transferred from your current location to the offices and servers of the Company and the authorized third parties referred to herein located in the United States.
            Other Information:
                Non-Identifiable Data: When you interact with the Company through the Services, we receive and store certain personally non-identifiable information. Such information, which is collected passively using various technologies, cannot presently be used to specifically identify you. The Company may store such information itself or such information may be included in databases owned and maintained by the Company affiliates, agents or service providers. The Services may use such information and pool it with other information to track, for example, the total number of visitors to our Site, the number of visitors to each page of our Site, and the domain names of our visitors' Internet service providers. It is important to note that no Personal Data is available or used in this process.
        ...
        Do Not Track: We may (and we may allow third party service providers to) use cookies or similar technologies to collect information about your browsing activities over time and across different websites following your use of our Site.  For example, we may use a third party analytics service to help us analyze how users use the Site and enhance your experience when you use the Site.  Our Site currently does not respond to “Do Not Track” (DNT) signals and operates as described in this Privacy Policy, whether or not a DNT signal is received. If we do so in the future, we will describe how we do so in this Privacy Policy.

        Our Use of Your Personal Data and Other Information:
        The Company uses the Personal Data you provide in a manner that is consistent with this Privacy Policy. If you provide Personal Data for a certain reason, we may use the Personal Data in connection with the reason for which it was provided. For instance, if you contact us by email, we will use the Personal Data you provide to answer your question or resolve your problem. The Company may also use your Personal Data and other personally non-identifiable information collected through the Services to help us improve the content and functionality of the Services, to better understand our users and to improve the Services. The Company and its affiliates may use this information to contact you in the future to tell you about services we believe may be of interest to you. If we do so, each marketing communication we send you will contain instructions permitting you to "opt-out" of receiving future marketing communications. In addition, if at any time you wish not to receive any future marketing communications or you wish to have your name deleted from our mailing lists, please contact us as indicated below.
        ...
        The Company is not in the business of selling your information. We consider this information to be a vital part of our relationship with you. There are, however, certain circumstances in which we may share your Personal Data with certain third parties without further notice to you, as set forth below:
            ...
            Business Partners: We may also share your Personal Data with business partners or other third parties in connection with products or services that we believe will be of interest to you.
        ...
        You may contact us as follows: team@thebeetoken.com
    </PrivacyWrapper>
);
